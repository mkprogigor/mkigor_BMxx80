...
class bme280 {
    public:
        ...
        uint8_t f_read_reg(uint8_t address);					// read 1 byte from bme280 register by i2c
        bool f_write_reg(uint8_t address , uint8_t data);		// write 1 byte to bme280 register
        bool f_reset(void);                 // bme280 software reset 
